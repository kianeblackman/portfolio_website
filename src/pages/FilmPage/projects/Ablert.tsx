...
export default function Ablert() {
  return (
    <div className="p-6 pt-16 w-full xs:w-1/2">
      <h1 className="font-head text-4xl font-bold text-neutral-800 xs:text-7xl">& Albert</h1>
      <h2 className="text-2xl xs:text-3xl">After a full day knocking on the doors of strangers and asking them if
        ...
        mans entire life and decided to document some of it.</h2>
      <br></br>
      <iframe className="w-full aspect-video " src="https://player.vimeo.com/video/438205315?title=0&;byline=0&;portrait=0"></iframe>
    </div>
  );
}

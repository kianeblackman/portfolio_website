    ...
    <div className="mx-6 mb-6 mt-16 md:w-3/4">
      ...
      <div>
        <div className="mt-6 mb-3 grid grid-cols-2 gap-6 md:w-3/4">
          <img
            src="/images/media-planet/cover-vision-matters.jpg"
            className="border-2 border-black p-1"
          />
          <img
            src="/images/media-planet/cover-body-empowerment.jpg"
            className="border-2 border-black p-1"
          />
          <img
            src="/images/media-planet/spread-aids.jpg"
            className="border-2 border-black p-1"
          />
          <img
            src="/images/media-planet/spread-head.jpg"
            className="border-2 border-black p-1"
          />
          <img
            src="/images/media-planet/spread-age.jpg"
            className="border-2 border-black p-1"
          />
          <img
            src="/images/media-planet/spread-pride.jpg"
            className="border-2 border-black p-1"
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-6 md:w-3/4">
        <img
          src="/images/media-planet/animation-main.gif"
          className="border-2 border-black p-1"
        />
        <img
          src="/images/media-planet/animation-icons.gif"
          className="border-2 border-black p-1"
        />
      </div>
    </div>

...
export default function MyStory() {
  return (
    <div>
      <h2 className="font-regular pb-3 font-head text-2xl underline underline-offset-4">My story:</h2>
        <div className="text-1xl font-body">
          ...
          <br></br>
          <p>Here's a video of me lituraly jumping into something I'd only been
          learning for an hour:</p>
          <br></br>
          <iframe className="aspect-video w-full" src="https://www.youtube.com/embed/kf4WRWkapfk"></iframe>
          <br></br>   
          <p>If you're not convinced by that, in <u>September 2022</u> I took another jump
          ...
          journey into code through the <u>School of Code bootcamp</u>. Out of 2000

...
export default function MyStory() {
  return (
    <div>
      <h2 className="font-regular pb-3 font-head text-2xl underline decoration-wavy underline-offset-auto">
        My story
      </h2>
      {/* <hr className='h-1 w-2/4 rounded bg-black border-0'></hr> */}
      <div className="text-1xl pt-3 font-body">
        <p>

...
function App() {
  ...
  return (
    <>
      <nav className="fixed z-1 grid h-6 w-full grid-cols-4">
        <div className="flex h-12 items-center justify-center bg-yellow-50">
          <NavLink to="/" onClick={() => setColour('#FFFBEB')}>
            <li className="text-1xl prevent-highlight flex list-none items-center justify-center gap-1 font-head font-medium transition delay-150 duration-100 hover:underline xs:text-2xl">
              ABOUT
            </li>
          </NavLink>
        </div>
